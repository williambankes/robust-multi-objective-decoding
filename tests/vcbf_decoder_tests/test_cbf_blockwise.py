...
from robust_multi_objective_decoding.decoders import BlockwiseFilteringDecoder, BlockwiseCBFClassifierDecoder
...
def test_blockwise_filtering_decoder_output_length():
    ...
    decoder = BlockwiseFilteringDecoder(reference_model=model, control_barrier_function=value_func, cbf_cutoff=0.5, alpha=0.5)
...
def test_blockwise_filtering_decoder_safe_generations():
    ...
    decoder = BlockwiseFilteringDecoder(reference_model=model,
                                        control_barrier_function=value_func,
                                        cbf_cutoff=0.5, alpha=0.5,
                                        num_branches=3, tree_depth=2
                                        )
